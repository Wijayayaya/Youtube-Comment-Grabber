...
urlpatterns = [
    ...
    path("admin/activity-logs/<int:pk>/", admin_views.activity_log_detail, name="admin-activity-log-detail"),
    path("admin/activity-logs/<int:pk>/delete/", admin_views.activity_log_delete, name="admin-activity-log-delete"),
